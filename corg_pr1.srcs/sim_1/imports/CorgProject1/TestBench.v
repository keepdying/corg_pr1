...
module Project1Test();
    ...
    always @(negedge Clock)
        ...
        begin
            ...
            $display("ALU FunSel: %b, ALU A : %b, ALU B: %b", ALU_FunSel, _ALUSystem.MuxCOut, _ALUSystem.BOut);
            ...
            $display("ALUOut: %b, ALUOutFlag: %d, ALUOutFlags: Z:%d, C:%d, N:%d, O:%d,", _ALUSystem.ALUOut, _ALUSystem.ALUOutFlag, _ALUSystem.ALUOutFlag[3],_ALUSystem.ALUOutFlag[2],_ALUSystem.ALUOutFlag[1],_ALUSystem.ALUOutFlag[0]);
